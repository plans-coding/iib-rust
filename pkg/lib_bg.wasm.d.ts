...
export const wasm_bindgen__convert__closures_____invoke__hd6dd8ddd162d443f: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__hd3f98b0044039791: (a: number, b: number) => void;
