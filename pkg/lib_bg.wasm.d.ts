...
export const wasm_bindgen__convert__closures_____invoke__hb6303756b209a30d: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__h5901f74a6643a8c7: (a: number, b: number) => void;
