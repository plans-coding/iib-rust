...
export const wasm_bindgen__convert__closures_____invoke__h3afcb9cace96ef0d: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__h3c30d884b410c426: (a: number, b: number) => void;
