...
export const wasm_bindgen__convert__closures_____invoke__hd963c04c8738e2fe: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__hd30f2ce1771bdfda: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h1f02cf9bb2511bdb: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__hdaf3c92d56dae149: (a: number, b: number) => void;
