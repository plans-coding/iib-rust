...
export const wasm_bindgen__convert__closures_____invoke__h6c787e50ecb034c2: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h9ad8ac1892a644ff: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h5d1f771e87740f0a: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__he1c7932eccef7a15: (a: number, b: number) => void;
