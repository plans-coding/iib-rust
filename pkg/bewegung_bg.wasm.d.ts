...
export const wasm_bindgen__convert__closures_____invoke__h83adf183fa3daf7d: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h9461008e47dcd1fa: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__hfa3ccf2cc864f8c4: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__heeb12583f9a8d85e: (a: number, b: number) => void;
