...
export const wasm_bindgen__convert__closures_____invoke__he5a184aa6ef48b44: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__hca1f1e57d0392036: (a: number, b: number) => void;
