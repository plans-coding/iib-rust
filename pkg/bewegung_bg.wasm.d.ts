...
export const wasm_bindgen__convert__closures_____invoke__h8225d6a622aa143e: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__hb9926c4ff3384788: (a: number, b: number) => void;
